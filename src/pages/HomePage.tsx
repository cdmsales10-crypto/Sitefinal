...
import { supabase, Product, Testimonial, Category } from "../lib/supabase";
import ProductCard from "../components/ProductCard";

// Default fallback data for Homepage
  ...
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      <section className="py-6 md:py-8 lg:py-12 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4">
          <h2 className="text-3xl md:text-5xl font-anton text-center mb-3 md:mb-4 text-red-600">
            How It Works
          </h2>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-3 sm:px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl md:text-5xl font-anton mb-2 md:mb-4 text-red-600">
              Our Products
            </h2>
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto font-poppins font-bold px-2">
              Premium quality detailing supplies trusted by professionals across
              India
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-6">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-3 font-anton text-sm md:text-base rounded uppercase ${
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="container mx-auto px-3 sm:px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-anton mb-3 md:mb-6 text-red-600">
                  Who We Are
                </h2>
                <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed font-jakarta">
                  Car Detailing Mart (CDM) is more than just a store - we're a
                  one-stop destination for all car detailing supply needs.
                  Serving detailing professionals, car wash centers, garages,
                  showrooms, and passionate car enthusiasts across India.
                </p>
              </div>
              <div>
                <img
          ...
          <div className="container mx-auto px-3 sm:px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed font-jakarta">
                  To become India's leading car detailing supply brand, known
                  for quality, reliability, and nationwide accessibility.
                </p>
                <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed font-jakarta">
                  We envision a future where CDM has a presence in every major
                  city across India, making professional-grade detailing
                  supplies accessible to everyone - from individual enthusiasts
                  to large-scale operations.
                </p>
                <p className="text-sm md:text-base text-gray-600 leading-relaxed font-jakarta">
                  Through franchises and company-owned branches, we're building
                  a network that ensures consistent quality and service
      ...
      <section className="py-12 md:py-16 bg-white overflow-x-hidden">
        <div className="container mx-auto px-3 sm:px-4">
          <h2 className="text-2xl md:text-4xl font-anton text-center mb-8 md:mb-12 text-red-600">
            Why Choose CDM?
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <div className="text-center p-4 md:p-6 bg-gray-50 rounded-lg md:rounded-xl hover:shadow-lg md:hover:shadow-xl transition-all">
              ...
              <h3 className="font-bold text-base md:text-xl mb-2 md:mb-3 text-gray-800">
                Premium Quality
              </h3>
              <p className="text-gray-600 text-sm md:text-base font-montserrat">
                Professional-grade products trusted by detailing experts
                nationwide
              </p>
            </div>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-gray-900 to-black overflow-x-hidden">
        <div className="container mx-auto px-3 sm:px-4">
          <h2 className="text-2xl md:text-4xl font-anton text-center mb-8 md:mb-12 text-white">
            Testimonials
          </h2>
          <div className="relative overflow-hidden">
            {/* Animation Container */}
            <div className="flex animate-scroll space-x-4 md:space-x-6">
              {/* Note: We duplicate the array [...testimonials, ...testimonials] to create the seamless infinite scroll effect */}
      ...
      <section className="py-20 bg-yellow-400">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-anton mb-6 text-white">
            Ready to Get Started?
          </h2>
          <p className="text-xl text-white font-poppins font-bold mb-8 max-w-3xl mx-auto">
            Join hundreds of satisfied customers and experience premium car
            detailing supplies
          </p>
          <button
